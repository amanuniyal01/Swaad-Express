...
const Starter = () => {
    ...
    return (
        <div className="starter">
            ...
            <button className="mt-6 px-6 py-3 cursor-pointer bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-[15px] shadow-lg hover:from-blue-600 hover:to-indigo-700 hover:scale-105 transition-transform duration-300 ease-in-out">
